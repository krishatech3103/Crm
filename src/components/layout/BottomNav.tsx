...
export const BottomNav: React.FC<BottomNavProps> = ({ onOpenAddLead }) => {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 pb-safe">
      <div className="glass-panel border-t border-indigo-500/20 px-2 py-1.5 flex items-center justify-around shadow-2xl shadow-indigo-950">
        <NavLink
          to="/"
          end
          className={({ isActive }) =>
            `flex flex-col items-center gap-1 px-2.5 py-1 rounded-xl text-[10px] font-semibold transition-all ${
